...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fullscreen","source","undo","redo","insertunorderedlist","unlink","insertorderedlist","link","selectall","searchreplace","help","preview","emotion","snapscreen","insertimage","pagebreak","gmap","attachment","insertvideo","date","time","wordimage","map","anchor","spechars","blockquote","template","background","fontfamily","lineheight","rowspacingtop","rowspacingbottom","paragraph","bold","italic","underline","strikethrough","forecolor","superscript","backcolor","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","removeformat","pasteplain","autotypeset","formatmatch","customstyle","imagecenter","imageright","imageleft","fontsize","imagenone","splittorows","mergedown","mergeright","deletetable","inserttable","splittocols","insertcol","mergecells","splittocells","insertrow","deleterow","deletecol","insertparagraphbeforetable"]]
