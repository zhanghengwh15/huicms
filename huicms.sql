...
-- ----------------------------
INSERT INTO `hui_admin` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '1', '127.0.0.1', 'upload/images/20130427/13670327662220.png', '王辉', '0', '13817918575', 'shuaige@52sum.com', '466209365', '', '141', '1', '2013-05-07 16:15:30', '0000-00-00 00:00:00', '2013-04-27 11:19:30');
...
CREATE TABLE `hui_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=171 DEFAULT CHARSET=utf8 COMMENT='管理员日志';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='系统配置表，配置值使用序列化数组存储';
...
-- ----------------------------
INSERT INTO `hui_links` VALUES ('1', 'PHP工作室', '/Public/Lib/ueditor/php/../../../upload//photo/5153214e77636.jpg', 'http://www.baidu.com', '', '#2F3192', '1', '10', '1', '0000-00-00 00:00:00', '2013-04-14 18:14:09');
INSERT INTO `hui_links` VALUES ('3', '中文站', '', 'http://www.baidu.com', '', '#707070', '0', '20', '1', '2013-04-14 15:44:22', '0000-00-00 00:00:00');
...
-- ----------------------------
INSERT INTO `hui_payment` VALUES ('2', '支付宝', '支付宝', 'Alipay', ' ', '0', ' ', '0', '1', '1', '1', 'HuiCMS团队', 'http://www.alipay.com', '1.0');
...
INSERT INTO `hui_role_nav` VALUES ('2', '模块管理', '0', '60');
...
INSERT INTO `hui_role_nav` VALUES ('7', '模板管理', '0', '100');
INSERT INTO `hui_role_nav` VALUES ('8', '数据', '1', '110');
INSERT INTO `hui_role_nav` VALUES ('9', '全局', '0', '120');
INSERT INTO `hui_role_nav` VALUES ('10', '订单管理', '1', '85');
...
CREATE TABLE `hui_role_node` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='节点表';
