                    ...
                    <div class="server">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="dbprefix" id="dbprefix" value="hui_" class="input"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="site_name" value="HuiCMS内容管理系统" class="input"></td>
                                <td><div id="J_install_tip_sitename"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">网站域名：</td>
                                <td><input type="text" name="site_url" value="http://<?php echo $domain ?>/" id="siteurl" class="input" autoComplete="off"></td>
                                <td><div id="J_install_tip_siteurl"><span class="gray">请以“/”结尾</span></div></td>
                            </tr>
                            <tr>
                                <td class="tar">关键词：</td>
                                <td><input type="text" name="site_keyword" value="神僮な尛孓,HuiCMS,网站建设,PHP,MySQL" class="input" autoComplete="off"></td>
                                <td><div id="J_install_tip_sitekeywords"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">描述：</td>
                                <td><textarea class="input" name="site_description" rows="8" style="width: 300px;">HuiCMS是一套使用ThinkPHP框架开发,基于PHP+MYSQL免费开源的企业网站系统；</textarea></td>
