...
class View {
	...
	public function __construct()
	{
		...
		spAddViewFunction('T', array( 'View', '__template_T'));
		spAddViewFunction('spUrl', array( 'View', '__template_spUrl'));
	}
	...
	{
            //echo "<pre>";print_r($GLOBALS['G_SP']['view']['debugging']);exit;
		try {
				$this->addfuncs();
				$this->displayed = TRUE;
				if($GLOBALS['G_SP']['view']['debugging'] && SP_DEBUG)$this->engine->debugging = TRUE;
				$this->engine->display($GLOBALS['G_SP']['view']['config']['template_dir']."/".$tplname);
		} catch (Exception $e) {
